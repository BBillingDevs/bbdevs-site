...
const TermsAndConditions = () => {
    return (
        <Box fontFamily="'Helvetica Neue', Helvetica, Arial, sans-serif" p="1em">
            ...
            <Text mb={6}>
                These terms and conditions apply to the Butterflies of Zimbabwe app (hereby referred to as
            ...
            <Text mb={6}>These terms and conditions are effective as of 2024-11-26</Text>
            <Heading as="h2" size="lg" mb={4}>
                Contact Us
            </Heading>
            <Text mb={6}>
